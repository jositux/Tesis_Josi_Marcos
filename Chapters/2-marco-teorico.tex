...
Lógicamente, después de apuntar las características principales del diseño colaborativo, se infiere que el rol del diseñador en el proceso debe cambiar necesariamente al incluir este nuevos socios creativos en un entorno que tradicionalmente le pertenecía. En la Figura \ref{fig: co} se puede apreciar la diferencia de un esquema de co-diseño respecto al diseño clásico o tradicional.
...
\begin{figure}
\centering
\includegraphics[width=12cm]{Img/CPD/cpd-fuzzy2.png}
...
DXF\footnote{\url{https://es.wikipedia.org/wiki/DXF}} e IGES{\url{https://wiki.eclipse.org/IGES_file_Specification}} son algunos formatos que resultaron de los esfuerzos en el intercambio de bases de datos de gráficos entre sistemas CAD.\vskip
...
\begin{figure}[h]
\includegraphics[width=14cm]{Img/CPD/cad-shared0.png}
\centering
...
\begin{figure}[h]
\includegraphics[width=7cm]{Img/CPD/grafica3.png}
\centering
...
\item \textbf{a) Métodos de síntesis de imágenes} \vskip
...
\begin{enumerate}
    ...
    \begin{figure}[h]
    \includegraphics[width=6cm]{Img/CPD/grafica4.png}
    \centering
    ...
    \begin{figure}[h]
    \includegraphics[width=7cm]{Img/CPD/grafica5.png}
    \centering
    ...
    \begin{figure}[h]
    \includegraphics[width=7cm]{Img/CPD/grafica6.png}
    \centering
...
Para un método de síntesis dado, algunos modelos de iluminación son más fáciles de implementar que otros, dependiendo de la naturaleza del método y de la complejidad del modelo de iluminación.\vskip
...
En ella aparecen los diferentes procesos de visualización (campos) de la Síntesis de Imágenes nombrados según la terminología
de uso más frecuente en castellano.
...
color_local = contribución_local();
...
A la pérdida de información espacial se conoce como \textbf{aliasing espacial}, y a las discontinuidades del movimiento (pérdida de información) que pueden aparecer en las animaciones de los objetos, se asocian (o se deben) al
\textbf{aliasing temporal}. 
...
\begin{enumerate}
    ...
    Sin embargo, como ocurre en el ejemplo, la superficie del modelo correspondiente a la proyección del píxel \textit{puede tener otros puntos con características diferentes al de la muestra}, por lo que se estaría produciendo una pérdida de información (aliasing) en la imagen sintetizada. \vskip
    ...
    \begin{itemize}
        \item \textbf{Sobremuestreo} (\textit{supersampling}) \vskip
    ...
    \item \textbf{Sobremuestreo adaptativo} (\textit{adaptative supersampling})\vskip
    Como en el caso anterior, esta técnica traza múltiples rayos por cada píxel, aunque en esta ocasión quedarán distribuidos de modo irregular, basándose en el principio de \textit{trazar más rayos donde más se necesiten}.\vskip
...
Para entender mejor cómo se efectúa la visualización de los modelos booleanos podemos recurrir al ray casting (porque se puede considerar como un subconjunto de ray tracing), es necesario recordar cuál es la información disponible para decidir qué superficies son visibles y  cuales no.
\begin{itemize}
...
\section{Intercambio de datos entre sistemas CAD}
...
\vskip 
\subsection{CAD Data Exchange basado en características}
...
\subsection{Data Exchange en entornos web}
